...
- The assignment in this module requires you to complete the bodies of seven different methods. Each of the seven methods can be solved by applying the **linear scan** solution strategy. I suggest that you approach each method from that perspective.
