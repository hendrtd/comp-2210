...
# COMP 2210 Fundamentals of Computing II <br> Fall 2021 Course Syllabus
...
001 - 008) and *Distance* (section D01). Campus sections involve in-person
instruction while Distance sections are conducted in online synchronous mode.
Course components are described below for each section type.

- *Lecture meetings*: Each Tuesday and Thursday we will hold an in-person
  lecture in Shelby 1103 from 8:00 AM CT until 9:15 AM CT that will be simulcast
  live via Zoom. Students enrolled in Campus sections are expected to attend
  lecture in-person but are not required to do so.  Students enrolled in the
  Distance section are expected to attend lecture via Zoom but are not required
  to do so.

- *Lab meetings*: Each Tuesday and Thursday GTAs will conduct in-person lab
  meetings available only to students enrolled in the Campus sections.
  In-person attendance in lab meetings is expected but not required.

- *Exams and Tests*: Exams and Programming Tests must be taken during scheduled
  course times. Students enrolled in Campus sections must take exams and
  programming tests during their scheduled lab meeting time in the scheduled lab
  meeting room. Students enrolled in the Distance section must take exams and
  programming tests during the scheduled lecture period. Proctoring arrangements
  for the Distance section will be announced in class.

- *Office Hours*: Instructor office hours will be held via Zoom at a set time
  each week for both Campus and Distance sections. The specific day/time will be
  announced on the first day of classes. In-person meetings are available if
  needed, and only by appointment.
...
*In-person meetings are available if needed and only by appointment.*
...
----  | -----          | ------ | ------------ | ------ | ------- | ----- | ---------
1     | 8/16 - 8/22    | M0     | H            |        |         |       |       
2-3   | 8/23 - 9/25    | M1     | H A          | 2, 4, 8, 11 | 1 | 1-4, 6 | 3, 4, 12 
4-5   | 9/6 - 9/19     | M2     | H A E T      | 5, 6 | 2, 3, 7 | 5, 8 | 2, 6-8
6-7   | 9/20 - 10/3    | M3     | H A          | 3, 7, 9 | 4 | 6, 17 | 3, 4 
8-9   | 10/4 - 10/17   | M4     | H A E T      | 5, 9-11 | 2, 4 | 6, 7, 15-17 | 4, 5 
10-11 | 10/18 - 10/31  | M5     | H A          | 12, 13 | 5, 10, 13 | 6, 18, 19, 21 | 5, 9, 12, 13 
12-13 | 11/1 - 11/14   | M6     | H A          | 15, 16 | 9, 11 | 6, 14, 20 | 1, 14
14-15 | 11/15 - 12/3   | M7     | H A T        |   | 6 | 24 | 1, 4  

The **Final Exam**, which is part of M7, will be given on the last lab day of
the course (December 2) and **not** on the day designated in the Final Exam
Schedule.
...
elements of this course including Zoom, Honorlock, Vocareum, Piazza, and all
